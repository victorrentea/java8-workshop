...
//	public static double getPrice(Customer customer, int price) {
//		return price * (100-getApplicableDiscountPercentage(customer.getMemberCard())) /100d;
//	}
	public static String getDiscountLine(Customer customer) {
		return customer.getMemberCard().flatMap(Optionals::getApplicableDiscountPercentage)
			.map(p -> "Discount%: " + p)
			.orElse("");
	}
